...
--Get Distict Tax  
select distinct TaxShortName, IDENTITY(int,1,1) as ID into #Taxdata from InvoiceTaxDetail  
...
select distinct PaymentMode, IDENTITY(int,1,1) as ID into #PaymentData from invoicepaymentdetails  
