...
namespace PMS.Resources.DAL
{
    public interface IDalFactory
    {
        ...
        List<PmsEntity.Booking> GetBookingTransaction(DateTime startDate, DateTime endDate, string guestName, string roomType, decimal amountPaid, string paymentMode, bool transactionStatus);
    }
}
