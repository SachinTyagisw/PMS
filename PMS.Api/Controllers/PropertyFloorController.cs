    ...
    public partial class PropertyFloorController : ApiController, IRestController
    {
        ...
        public PmsResponseDto AddFloor([FromBody] PropertyFloorRequestDto request)
        {
            ...
            if (Id > 0)
            {
                ...
                response.StatusDescription = "New Floor Added successfully.";
        ...
        public PmsResponseDto UpdateFloor([FromBody] PropertyFloorRequestDto request)
        {
            ...
            {
                response.ResponseStatus = PmsApiStatus.Success.ToString();
                response.StatusDescription = "Floor Updated successfully.";
            }
            else
            {
                response.ResponseStatus = PmsApiStatus.Failure.ToString();
                response.StatusDescription = "Floor Updation failed.Contact administrator.";
            }
            return response;
        }
        ...
        public PmsResponseDto DeleteFloor(int propertyFloorId)
        {
            ...
            {
                response.ResponseStatus = PmsApiStatus.Success.ToString();
                response.StatusDescription = "Floor Deleted successfully.";
            }
            else
            {
                response.ResponseStatus = PmsApiStatus.Failure.ToString();
                response.StatusDescription = "Floor Deletion failed.Contact administrator.";
            }
            return response;
        }
